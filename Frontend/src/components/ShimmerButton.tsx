    ...
    return (
      <button
        ...
        className={cn(
          ...
          "[border-radius:var(--radius)] border border-white/10 px-6 py-3 whitespace-nowrap text-white",
          "[background:var(--bg)] transform-gpu transition-transform duration-300 ease-in-out",
      ...
      >
        ...
        <div className="-z-30 blur-[2px] [container-type:size] absolute inset-0 overflow-visible">
          <div className="animate-shimmer-slide absolute inset-0 [aspect-ratio:1] h-[100cqh]">
